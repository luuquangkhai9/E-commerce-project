...
INSERT INTO `admin_passwords` VALUES (1,1,'119a81fee4c497a4f8a413b511f34b3fc1a2533daddaacd7ed18c8f2534d2dbf:LVb4mDjDki4sHAh3zPiEM0MBwyctE3ii:3_32_2_67108864',0,1730810232);
...
INSERT INTO `admin_user` VALUES (1,'john','smith','john.smith@gmail.com','john.smith','119a81fee4c497a4f8a413b511f34b3fc1a2533daddaacd7ed18c8f2534d2dbf:LVb4mDjDki4sHAh3zPiEM0MBwyctE3ii:3_32_2_67108864','2024-11-05 12:37:12','2024-11-05 12:37:12',NULL,0,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL);
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2024-11-05 12:37:11','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2024-11-05 12:37:09','2024-11-05 12:37:09','1',0,0,1),(2,3,1,'2024-11-05 12:37:09','2024-11-05 12:37:09','1/2',1,1,0);
...
INSERT INTO `catalog_product_index_website` VALUES (1,1,'2024-11-05',1);
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'catalog/search/engine','elasticsearch7','2024-11-05 12:36:58'),(2,'default',0,'catalog/search/elasticsearch7_server_hostname','elasticsearch','2024-11-05 12:36:58'),(3,'default',0,'catalog/search/elasticsearch7_server_port','9200','2024-11-05 12:36:58'),(4,'default',0,'web/seo/use_rewrites','1','2024-11-05 12:36:58'),(5,'default',0,'web/unsecure/base_url','https://magento.test/','2024-11-05 12:36:58'),(6,'default',0,'web/secure/base_url','https://magento.test/','2024-11-05 12:36:58'),(7,'default',0,'general/locale/code','en_US','2024-11-05 12:36:58'),(8,'default',0,'general/locale/timezone','America/New_York','2024-11-05 12:36:58'),(9,'default',0,'currency/options/base','USD','2024-11-05 12:36:58'),(10,'default',0,'currency/options/default','USD','2024-11-05 12:36:58'),(11,'default',0,'currency/options/allow','USD','2024-11-05 12:36:58'),(12,'default',0,'general/region/display_all','1','2024-11-05 12:36:59'),(13,'default',0,'general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,CR,CZ,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,UA,US,UY,VE','2024-11-05 12:37:06'),(14,'default',0,'catalog/category/root_id','2','2024-11-05 12:37:09'),(15,'default',0,'twofactorauth/duo/application_key','4AphJ6mCR901hD70JvwuDiSlozldAQJxyTWjHWmQKGHSkl2dClGQM42BXxmXO7OX','2024-11-05 12:37:10'),(16,'default',0,'analytics/subscription/enabled','1','2024-11-05 12:37:10'),(17,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2024-11-05 12:37:10'),(18,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2024-11-05 12:37:11'),(19,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2024-11-05 12:37:11'),(20,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2024-11-05 12:37:11');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COMMENT='Flag';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2024-11-05 12:37:10'),(2,'feed_metadata_salesOrders',0,'{\"lockedBy\":\"full reindex(legacy)(70)\"}','2024-11-05 12:39:19'),(3,'feed_metadata_salesOrderStatuses',0,'{\"lockedBy\":\"full reindex(legacy)(70)\"}','2024-11-05 12:39:19'),(4,'feed_metadata_stores',0,'{\"lockedBy\":\"full reindex(legacy)(70)\"}','2024-11-05 12:39:19'),(5,'config_hash',0,'{\"system\":\"2be88ca4242c76e8253ac62474851065032d6833\"}','2024-11-05 12:39:21');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2024-11-06 04:42:30','bcefa43df3fd11f5a7f3ecab56670c10'),(2,'customer_grid','valid','2024-11-05 12:39:17','15b6e3801e47a883c74661dc3802210b'),(3,'catalog_category_product','valid','2024-11-05 12:39:17','aa2703cdcecda3c30d4e558329996b06'),(4,'catalog_product_category','valid','2024-11-05 12:39:17','054adc6684bae392abdc5fe5ef1e16c9'),(5,'catalogrule_rule','valid','2024-11-05 12:39:17','2a6958eb8c2df1307a035dc17817b0aa'),(6,'catalog_product_attribute','valid','2024-11-05 12:39:18','1c9607e88e703431c5f0eba00fb60eb4'),(7,'cataloginventory_stock','valid','2024-11-05 12:39:18','6b1cf7daa9e3a04ce94a4ad3e65de746'),(8,'inventory','valid','2024-11-05 12:39:18','941e38582cb985d03186d69d258a389f'),(9,'catalogrule_product','valid','2024-11-05 12:39:18','138f12019c784bece33e185e3b818440'),(10,'catalog_product_price','valid','2024-11-05 12:39:18','f00db7c2711278db7832fe14c73a257d'),(11,'catalogsearch_fulltext','valid','2024-11-05 12:39:19','9c0943bc0ca04a068733de47f3974314'),(12,'sales_order_data_exporter','valid','2024-11-05 12:39:19','1653cd0517930ade43109bc45468e086'),(13,'sales_order_status_data_exporter','valid','2024-11-05 12:39:19','7ee5ff75dba4c1e31116fda1cc50a9ee'),(14,'store_data_exporter','valid','2024-11-05 12:39:19','52cee4841318a783c42458cbab756f8d');
...
INSERT INTO `mview_state` VALUES (1,'design_config_dummy','enabled','idle','2024-11-06 04:42:30',0),(2,'customer_dummy','enabled','idle','2024-11-06 04:42:29',0);
...
INSERT INTO `queue_poison_pill` VALUES ('version-672af3b5adb69');
...
INSERT INTO `sales_data_exporter_order_statuses` VALUES ('canceled','{\"status\":\"canceled\",\"label\":\"Canceled\"}','2024-11-05 12:39:19'),('closed','{\"status\":\"closed\",\"label\":\"Closed\"}','2024-11-05 12:39:19'),('complete','{\"status\":\"complete\",\"label\":\"Complete\"}','2024-11-05 12:39:19'),('fraud','{\"status\":\"fraud\",\"label\":\"Suspected Fraud\"}','2024-11-05 12:39:19'),('holded','{\"status\":\"holded\",\"label\":\"On Hold\"}','2024-11-05 12:39:19'),('payment_review','{\"status\":\"payment_review\",\"label\":\"Payment Review\"}','2024-11-05 12:39:19'),('paypal_canceled_reversal','{\"status\":\"paypal_canceled_reversal\",\"label\":\"PayPal Canceled Reversal\"}','2024-11-05 12:39:19'),('paypal_reversed','{\"status\":\"paypal_reversed\",\"label\":\"PayPal Reversed\"}','2024-11-05 12:39:19'),('pending','{\"status\":\"pending\",\"label\":\"Pending\"}','2024-11-05 12:39:19'),('pending_payment','{\"status\":\"pending_payment\",\"label\":\"Pending Payment\"}','2024-11-05 12:39:19'),('pending_paypal','{\"status\":\"pending_paypal\",\"label\":\"Pending PayPal\"}','2024-11-05 12:39:19'),('processing','{\"status\":\"processing\",\"label\":\"Processing\"}','2024-11-05 12:39:19');
...
INSERT INTO `setup_module` VALUES ('Magento_DataExporter','42.0.1','42.0.1'),('Magento_QueryXml','42.0.0','42.0.0'),('Magento_Securitytxt','1.0.0','1.0.0'),('Magento_ServicesConnector','1.1.0','1.1.0'),('Magento_ServicesId','1.1.0','1.1.0'),('Magento_ServicesIdLayout','1.0.0','1.0.0'),('Mongcake_VcbCurrency','1.0.0','1.0.0'),('PayPal_Braintree','4.6.1','4.6.1');
...
INSERT INTO `stores_data_exporter` VALUES (1,'{\"store_view_id\":\"1\",\"store_id\":1,\"website_id\":1,\"store_view_name\":\"Default Store View\",\"store_name\":\"Main Website Store\",\"website_name\":\"Main Website\"}','2024-11-05 12:39:19');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_672a117315458.jpeg',0,'frontend',0,'Magento/blank'),(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(3,1,'Magento/luma','Magento Luma','preview_image_672a117330f22.jpeg',0,'frontend',0,'Magento/luma');
...
-- Dump completed on 2024-11-06  6:36:30
