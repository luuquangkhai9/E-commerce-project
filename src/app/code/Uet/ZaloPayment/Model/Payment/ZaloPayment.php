...
namespace Uet\ZaloPayment\Model\Payment;

use Uet\ZaloPayment\Helper\Data as HelperData;
use Uet\ZaloPayment\Helper\ZaloPayHelper;
use Uet\ZaloPayment\Helper\ZaloPayMacGenerator;
...
class ZaloPayment extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public function getZaloPaymentRequest(Order $order)
    {
        ...
        if (is_array($description)) {
            $params['description'] = $this->_helperData->getStoreName2() . ' : ' . join(', ', $description);
        }
